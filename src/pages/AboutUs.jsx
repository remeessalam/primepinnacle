    ...
    <>
      ...
      <section className="text-white wrapper py-[3rem]">
        ...
        <div className="mt-[3rem]">
          <h2 data-aos="fade-up" className="heading-2 text-center text-primary">
            Our Visionary Goals
          </h2>
      ...
      <TrustWorthySection />
      <section className="wrapper py-[3rem] bg-primary">
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-7">
          ...
          >
            <div className="flex flex-col items-center lg:items-start gap-5">
              ...
              <p className="desc">
                At <b>PRIME PINNACLE</b>, our team is at the heart of every
