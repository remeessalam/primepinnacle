      ...
      <div className="py-[3rem]">
        <div className="wrapper">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl mx-auto">
            <div
              data-aos="fade-up"
              className="bg-primary flex flex-col gap-3 items-center justify-center rounded-xl p-5"
            >
              <MapPin
                strokeWidth={2}
                size={40}
                className="text-white inline min-w-5"
              />
            ...
            <Link
              ...
              className="bg-primary flex flex-col gap-3 items-center justify-center rounded-xl p-5"
            >
              <Mail strokeWidth={2} size={40} className="text-white inline" />
              <span className="text-center font-medium">
            ...
            <Link
              ...
              className="bg-primary flex flex-col gap-3 items-center justify-center rounded-xl p-5"
            >
              <Phone strokeWidth={2} size={40} className="text-white inline" />
              <span className="text-center font-medium">
