      ...
      >
        ...
        <div className="mt-5 grid sm:grid-cols-2 gap-6">
          {services.map((service) => (
            <div
              data-aos="fade-up"
              className="bg-primary items-center rounded-lg p-5 flex text-center flex-col"
            >
              <div className="w-[4rem] h-[4rem] bg-white rounded-full flex justify-center items-center text-primary ">
