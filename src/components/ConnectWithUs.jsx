...
const ConnectWithUs = () => {
  return (
    ...
    >
      {/* <div className="absolute top-0 w-full h-full bg-primary/10"></div> */}
      <div data-aos="fade-up" className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="py-[3rem] px-5  rounded-xl text-white relative z-10">
            <h1 className="heading-2 max-w-[60rem] mx-auto text-center">
              Let's Build Something Amazing Together! Connect with Us Today!
            </h1>
            <p className="font-light max-w-[50rem] text-center mx-auto mt-3 !text-lg text-white">
