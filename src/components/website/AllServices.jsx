...
const AllServices = () => {
  ...
  return (
    <section className="wrapper py-[5rem] flex flex-col gap-5 items-center">
      ...
      <h2
        data-aos="fade-up"
        className="heading-2 max-w-[60rem] mx-auto text-center text-primary"
      >
      ...
      <div className="mt-5 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {allServices.map((service) => (
          <div
            data-aos="fade-up"
            className="bg-secondary group  hover:bg-primary shadow-xl rounded-lg p-5 flex text-center flex-col justify-between transition-color duration-300"
          >
            <div className="flex flex-col items-center">
              {/* <img
                ...
                alt=""
              /> */}
              <div className="w-[4rem] h-[4rem] group-hover:scale-105 transition-all duration-300 rounded-full bg-primary/50 group-hover:bg-white flex justify-center items-center">
                {service.iconComponent}
              </div>

              <h6 className="text-xl font-medium mt-2 text-primary group-hover:text-white">
                {service.title}
              </h6>
