    ...
    >
      ...
      <div data-aos="fade-up" className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="py-[3rem] px-5 bg-white rounded-xl text-white relative z-10">
            <h1
              data-aos="fade-up"
            ...
            >
              {content.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col group shadow-xl items-center gap-3 bg-gradient-to-b from-primary to-secondary rounded-xl p-5 transition-all duration-200"
                >
