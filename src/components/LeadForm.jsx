  ...
  return (
    <div className="flex flex-col gap-5 py-[5rem]">
      ...
      <form
        ...
        data-aos="fade-up"
        className="flex flex-col w-full gap-4 rounded-xl p-5 bg-primary max-w-3xl mx-auto mt-5"
      >
        <div className="grid sm:grid-cols-2 gap-5">
          <div className="flex flex-col gap-1">
            ...
            <input
              type="text"
              className="outline-none p-2 rounded-full bg-white/60 text-black"
              placeholder="Name"
              {...register("name", {
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            rows="4"
            className="outline-none p-2 rounded-2xl bg-white/60 text-black"
            placeholder="Message"
            {...register("message", {
